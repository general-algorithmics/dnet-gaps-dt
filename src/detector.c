...
void run_detector(int argc, char **argv)
{
  ...
  char *yurl   = find_char_arg(argc, argv, "-yurl", 0);
  ...
  else if(0==strcmp(argv[2], "demo"))
  {
    ...
    if ( yurl )
    {
      demo_yurl(cfg, weights, thresh, yurl, output, names, classes, frame_skip, prefix, hier_thresh);
    }
    else
    {
      demo(cfg, weights, thresh, cam_index, filename, output, names, classes, frame_skip, prefix, hier_thresh);
    }
  }
}
